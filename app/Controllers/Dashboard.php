...
class Dashboard extends BaseController
{
    ...
    public function index()
    {
        ...
        $apiUrl = "http://127.0.0.1:5000/projects?id_pegawai={$id_pegawai}";
        $curl = curl_init();
    ...
    public function pegawai()
    {
        ...
        $apiUrl = "http://127.0.0.1:5000/datadash/{$id_pegawai}";
        $curl = curl_init();
    ...
    public function uploadFile()
    {
        ...
        if ($this->request->getMethod() === 'post') {
            ...
            if ($file->isValid() && !$file->hasMoved()) {
                ...
                $apiUrl = 'http://127.0.0.1:5000/tugasDrive?ID_detail=' . $id_detail; // Include id_detail in the URL
                $ch = curl_init($apiUrl);
                curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
