...
class admin extends BaseController
{
    ...
    public function index()
    {
        ...
        $apiUrl = "http://127.0.0.1:5000/admin/project";
        $curl = curl_init();
    ...
    public function pegawai()
    {
        ...
        $apiUrl = "http://127.0.0.1:5000/pegawai";
        $curl = curl_init();
    ...
    public function updateDataPegawai()
    {
        ...
        $apiUrl = "http://127.0.0.1:5000/pegawai/$id";
    ...
    public function hapusPegawai($id)
    {
        ...
        $api_url = 'http://127.0.0.1:5000/hapus_pegawai/' . $id;
    ...
    public function project()
    {
        ...
        $projectApiUrl = "http://127.0.0.1:5000/admin/project";

        // URL API untuk data perusahaan
        $perusahaanApiUrl = "http://127.0.0.1:5000/perusahaan";

        // URL API untuk data vendor
        $vendorApiUrl = "http://127.0.0.1:5000/vendor";
        $ferifApiUrl = "http://127.0.0.1:5000/tahapan/admin";
    ...
    public function updateDataProject()
    {
        ...
        // Di sini, Anda dapat menggunakan fungsi atau metode yang sesuai dalam model Anda
        // untuk mengirim data ke API dengan URL yang ditentukan.
        $apiUrl = "http://127.0.0.1:5000/editproject/$id";
    ...
    public function hapusProject($id)
    {
        ...
        // Tentukan URL API
        $api_url = 'http://127.0.0.1:5000/hapusproject/' . $id;
    ...
    public function verifProject()
    {
        ...
        // Di sini, Anda dapat menggunakan fungsi atau metode yang sesuai dalam model Anda
        // untuk mengirim data ke API dengan URL yang ditentukan.
        $apiUrl = "http://127.0.0.1:5000/project/selesai/admin/$id";
    ...
    public function Profile()
    {
        ...
        $apiUrl = "http://127.0.0.1:5000/pegawain/$id_pegawai";
        $curl = curl_init();
    ...
    public function updateProfile()
    {
        ...
        // Di sini, Anda dapat menggunakan fungsi atau metode yang sesuai dalam model Anda
        // untuk mengirim data ke API dengan URL yang ditentukan.
        $apiUrl = "http://127.0.0.1:5000/editProfile/$id";
    ...
    public function Perusahaan()
    {
        ...
        $apiUrl = "http://127.0.0.1:5000/perusahaan";
        $curl = curl_init();
    ...
    public function updateDataPerusahaan()
    {
        ...
        // Di sini, Anda dapat menggunakan fungsi atau metode yang sesuai dalam model Anda
        // untuk mengirim data ke API dengan URL yang ditentukan.
        $apiUrl = "http://127.0.0.1:5000/edit_perusahaan/$id";
    ...
    public function hapusPerusahaan($id)
    {
        ...
        // Tentukan URL API
        $api_url = 'http://127.0.0.1:5000/hapus_perusahaan/' . $id;
    ...
    public function Tahapan_admin($id, $nama_project, $no_po, $status, $deadline)
    {
        ...
        $apiUrl = "http://127.0.0.1:5000/tahapan?ID_project=$id";
        $curl = curl_init();
        ...
        if ($err) {
            ...
            $apiUrl2 = "http://127.0.0.1:5000/detail/admin";
            $curl2 = curl_init();
    ...
    public function updateDataTahapan()
    {
        ...
        // Di sini, Anda dapat menggunakan fungsi atau metode yang sesuai dalam model Anda
        // untuk mengirim data ke API dengan URL yang ditentukan.
        $apiUrl = "http://127.0.0.1:5000/editTahapan/$id";
    ...
    public function hapusTahapan($id)
    {
        ...
        $api_url = 'http://127.0.0.1:5000/hapus_tahapan/' . $id;
    ...
    public function verifTahapan()
    {
        ...
        // Di sini, Anda dapat menggunakan fungsi atau metode yang sesuai dalam model Anda
        // untuk mengirim data ke API dengan URL yang ditentukan.
        $apiUrl = "http://127.0.0.1:5000/tahapan/selesai/admin/$id";
    ...
    public function updateDetail()
    {
        ...
        // Di sini, Anda dapat menggunakan fungsi atau metode yang sesuai dalam model Anda
        // untuk mengirim data ke API dengan URL yang ditentukan.
        $apiUrl = "http://127.0.0.1:5000/editDetail/$id";
    ...
    public function hapusDetail($id)
    {
        ...
        // Tentukan URL API
        $api_url = "http://127.0.0.1:5000/hapus_detail/$id";
    ...
    public function uploadFile()
    {
        ...
        if ($this->request->getMethod() === 'post') {
            ...
            if ($file->isValid() && !$file->hasMoved()) {
                ...
                $apiUrl = 'http://127.0.0.1:5000/tugasDriveTahapan?id_tahapan=' . $id_tahapan; // Include id_detail in the URL
                $ch = curl_init($apiUrl);
                curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
    ...
    public function detail($id_tahapan, $nama_tahapan, $nama_project)
    {
        ...
        //     }
        // Menggunakan cURL untuk mengambil data dari API
        $api_url = "http://127.0.0.1:5000/detail?ID_tahapan=" . $id_tahapan;
    ...
    public function output($id_tahapan, $nama_tugas, $id_detail)
    {
        ...
        // Build the API URL
        $apiUrl = "http://127.0.0.1:5000/detail?ID_tahapan=" . $id_tahapan; // You can change the query parameter as needed
        ...
        if ($apiData === false) {
            ...
            $fileApiUrl = "http://127.0.0.1:5000/hasilTugas?id_detail=" . $id_detail;
    ...
    public function project_pegawai($id, $nama_project)
    {
        ...
        // URL API untuk data proyek
        $strukturApiUrl = "http://127.0.0.1:5000/struktur/$id";

        // URL API untuk data perusahaan
        $tambahApiUrl = "http://127.0.0.1:5000/pegawai";
    ...
    public function updateDataStruktur()
    {
        ...
        // Di sini, Anda dapat menggunakan fungsi atau metode yang sesuai dalam model Anda
        // untuk mengirim data ke API dengan URL yang ditentukan.
        $apiUrl = "http://127.0.0.1:5000/edit_struktur/$old_id_pegawai/$id_project";
    ...
    public function hapusStruktur($id_pegawai, $id_project)
    {
        ...
        // Tentukan URL API
        $api_url = "http://127.0.0.1:5000/struktur/$id_pegawai/$id_project";
    ...
    public function vendor()
    {
        ...
        $apiUrl = "http://127.0.0.1:5000/vendor";
        $curl = curl_init();
    ...
    public function updateDataVendor()
    {
        ...
        // Di sini, Anda dapat menggunakan fungsi atau metode yang sesuai dalam model Anda
        // untuk mengirim data ke API dengan URL yang ditentukan.
        $apiUrl = "http://127.0.0.1:5000/edit_vendor/$id";
    ...
    public function hapusVendor($id)
    {
        ...
        // Tentukan URL API
        $api_url = 'http://127.0.0.1:5000/hapus_vendor/' . $id;
